...
export const LudoDice: React.FC<LudoDiceProps> = ({
  ...
  // The die cells below are plain divs (styling depends on inline transforms
  // that would fight a real <button>'s own box model), so keyboard support
  // has to be added by hand: without this, choosing which die to play after
  // a roll only works with a mouse or touch.
